...
export const metodePembayaran = [
  ...
  },
  {
    id: 6,
    value: "danamon",
    icon: "https://idn-static-assets.s3-ap-southeast-1.amazonaws.com/emailblast/assets/merchant/img_logo_merchant_danamon.png",
    label: "Bank Danamon",
  },
  {
    id: 7,
    value: "prismalink_permata",
    icon: "https://idn-static-assets.s3-ap-southeast-1.amazonaws.com/emailblast/assets/merchant/img_logo_merchant_bankpermata.png",
    label: "Bank Permata",
  },
];
