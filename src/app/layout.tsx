      ...
      dangerouslySetInnerHTML={{
        __html: `
          !function(w,d,t){
            ...
            for(var i=0;i<ttq.methods.length;i++) ttq.setAndDefer(ttq,ttq.methods[i]);
            ttq.instance = function(t){ for(var e = ttq._i[t] || [], n=0; n<ttq.methods.length; n++) ttq.setAndDefer(e, ttq.methods[n]); return e };
            ttq.load = function(e,n){ var r = "https://analytics.tiktok.com/i18n/pixel/events.js"; ttq._i = ttq._i || {}; ttq._i[e] = []; ttq._i[e]._u = r; ttq._t = ttq._t || {}; ttq._t[e] = +new Date; ttq._o = ttq._o || {}; ttq._o[e] = n || {}; var s = document.createElement("script"); s.type="text/javascript"; s.async=true; s.src = r + "?sdkid=" + e + "&lib=" + t; var eTag = document.getElementsByTagName("script")[0]; eTag.parentNode.insertBefore(s, eTag); };
            ${process.env.NEXT_PUBLIC_TIKTOK_PIXEL_ID ? `ttq.load('${process.env.NEXT_PUBLIC_TIKTOK_PIXEL_ID}'); ttq.page();` : ''}
          }(window, document, 'ttq');
        `,
      }}
    />
