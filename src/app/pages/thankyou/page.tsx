...
export default function ThankYou() {
  return (
    <div className="w-full min-h-screen flex flex-col lg:items-center md:items-center p-4 bg-white">
      {/* <FeedbackPopup /> */}
      ...
      <div className="flex flex-col max-w-md px-4">
        ...
        <p className="text-center text-gray-600 text-sm md:text-base mt-1">
          Silahkan check email atau WhatsApp kamu untuk menerima informasi terbaru dari tim kami. Stay tuned! 🚀
        </p>
      </div>
